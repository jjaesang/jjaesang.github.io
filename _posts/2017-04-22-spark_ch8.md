...
실행하는 애플리케이션의 SparkConf는 한번 SparkContext의 Contructor에 넘겨지고나면
...
#### Job: 진행 상황과 작업 단계, 태스크 등에 대한 수치들

#### Storage: 영속화된 RDD의 정보

#### Executor: 애플리케이션에 존재하는 Executor 목록
...
ex) 하나의 application에 1000개의 코어를 설정했는데 , 30개의 Task만 실행ㅇ하는 작업이라면.. 늘리자. 
